...
import static com.example.lixiang.music_player.R.id.lyric_view;
import static com.example.lixiang.music_player.R.id.refresh;
...
import static com.tencent.bugly.beta.ui.h.v;
...
//        final FloatingActionButton random_play = (FloatingActionButton) findViewById(R.id.random_play);
    ...
    public void animation_change_color(int Int) {
        ...
        RelativeLayout lyriclayout = (RelativeLayout) findViewById(R.id.lyric_layout);
        int h = lyriclayout.getHeight();
        ShapeDrawable mDrawable = new ShapeDrawable(new RectShape());
        mDrawable.getPaint().setShader(new LinearGradient(0, 0, 0, h, Color.parseColor("#00000000"), Int1, Shader.TileMode.REPEAT));
        lyriclayout.setBackground(mDrawable);
    }
